...
/**
 * AboutModal component displays app info, author, license, and technologies.
        ...
        <Box>
          ...
          <Box>
            <Typography variant="body1" gutterBottom>
              <span style={{ fontWeight: 600 }}>Quote Generator</span> is an open-source app built
              with Vite, React, TypeScript, and Material UI. It fetches quotes from public APIs and
              provides a local fallback for offline use.
            </Typography>
            ...
            <Typography variant="body2" color="text.secondary" gutterBottom>
              ...
              <Link
                href="https://github.com/Vaporjawn/quote-generator"
                target="_blank"
                rel="noopener"
              >
                GitHub Repository
            ...
            <Typography variant="body2" color="text.secondary" gutterBottom>
              <span style={{ fontWeight: 600 }}>Technologies:</span> Vite, React, TypeScript,
              Material UI
            </Typography>
